...
const HeroSection: React.FC = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      // Example of fetching smart contract data
  ...
  const handleFetchData = async () => {
    try {
      // Call fetchData from smart contract with a specific key or ID (e.g., 'id1')
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-1 gap-8">
          <div className="p-8 bg-gray-800 rounded-lg shadow-lg">
            <div className="flex items-center mb-4">
              <svg className="w-8 h-8 text-gray-400 mr-4" fill="currentColor" viewBox="0 0 24 24">
