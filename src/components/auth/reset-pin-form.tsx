...
export default function ResetPinForm() {
  // Initialize the router object to enable programmatic navigation
  const router = useRouter();



// Handle user navigation to the minimal page
...
const handleRegisterBUSD = () => {
  ...
  return (
    <>
      ...
      />
      {/* Log In button */}
      {/* This button triggers the handleRegisterBUSD function when clicked */}
      <Button
        type="submit"
